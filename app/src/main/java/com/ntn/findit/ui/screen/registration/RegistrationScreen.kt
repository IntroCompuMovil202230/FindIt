    ...
    Column(modifier = Modifier.padding(vertical = 45.dp, horizontal = 25.dp)) {
        ...
        TitledInputColumn {
            TitledInput(
                ...
                hint = "Nombre",
                value = username,
                listener = { _viewModel.onUsernameChange(it) })
        }
        CustomSpacer()
        TitledInputColumn {
            TitledInput(
                ...
                hint = "Correo",
                value = email,
                listener = { _viewModel.onEmailChange(it) })
        }
        CustomSpacer()
        ...
        CustomSpacer(35.0)
        ConfirmationSection(_viewModel){
...
@Composable
fun ConfirmationSection(_viewModel: RegistrationViewModel, buttonAction: ()->Unit) {
